...
Param.K = 100.0; % board spring constant
Param.B = 10.0; % damping constant
Param.L1 = 0.434*body_height; % length of trunk in m taken from https://exrx.net/Kinesiology/Segments
Param.L2 = 0.433*body_height; % length of thigh in m taken from https://exrx.net/Kinesiology/Segments
Param.L3 = 0.63*body_height; % length of leg in m taken from https://exrx.net/Kinesiology/Segments
...
Param.tdurLB = 1;
Param.thetBUB = pi/6; Param.thetBLB = -pi/6;
